      ...
      <div style="display: block;" class="tab-pane" v-for="(item,i) of data" :key="i">
        ...
        <div class="g-l-p">
          <div class="g-l-p-title">
            ...
            <div class="g-l-right">
              <a class="btn" @click="concern(item.uid)" :data-uid="item.uid">+ 关注</a>
            </div>
            <p>{{item.pname}}</p>
              ...
              <table>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a :data-pid="item.uid" class="btn">我想要</a>
                    </td>
                  </tr>
                </tbody>
              </table>
...
export default {
  ...
  methods: {
    ...
    checklog() {
      ...
      if (begin != -1) {
        ...
        document.getElementById("pageNameD").innerHTML =
          "<h1>对不起，" +
  ...
  created() {
    this.isActive(), this.checklog(), this.Recommendation();
  },
  mounted() {},
  components: {
    RegLogin,
