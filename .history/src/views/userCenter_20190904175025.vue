    ...
    <div class="bg-green">
        <div class="p-c-body">
            <div class="person-list">
				...
				<!-- 个人中心 -->
					<li class="nav-item">
						<a @click="tabshow(c1)" class="nav-">
						<img src="../../public/images/usercenter/fangzi.png" alt="">个人中心</a>
					</li>
				<!-- 收藏 -->
					<li class="nav-item">
						<a @click="tabshow(c2)" class="nav-"><img src="../../public/images/usercenter/shoucang.png" alt="">收藏</a>
					</li>
				<!-- 关注 -->
					<li class="nav-item">
						<a @click="tabshow(c3)" class="nav-"><img src="../../public/images/usercenter/shoucang.png" alt="">关注</a>
					</li>
				<!-- 聊天 -->
					<li class="nav-item">
						<a @click="tabshow(c4)" class="nav-"><img src="../../public/images/usercenter/liaotian.png" alt="">聊天</a>
					</li>
				<!-- 评论 -->
					<li class="nav-item">
						<a @click="tabshow(c5)" class="nav-"><img src="../../public/images/usercenter/pinglun.png" alt="">评论</a>
					</li>
				<!-- 账号中心 -->
					<li class="nav-item">
						<a @click="tabshow(c6)" class="nav-"><img src="../../public/images/usercenter/zhanghao.png" alt="">交易记录</a>
					</li>
				</ul>
            </div>
            <!-- 个人信息 -->
