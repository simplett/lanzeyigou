<template>
	<div>
		...
		<!-- 猜你喜欢商品展示 -->
		<div id="bg" class="guess-like">
			<div class="guess-like-img">
				<img src="../../public/images/喜欢小banner.png" alt />
			</div>
			<div id="sm" class="guess-like-products">
				<table>		<!--外表格1x2,且第2单元格是空的-->
					<tr>
						<td id="Pic1">
							<table>	<!--内表格1x9,存放9张图片-->
								<tr>
									<td v-for="(item,i) of 12" :key="i" :data-id="item.pid">
										<img src="./images/1.jpg" οnmοuseοver="mouseover(this)" οnmοuseοut="mouseout(this)"/>
									</td>
							    </tr>
						   </table>
					   </td>
	...
	export default {
		data() {
			return {
				...
				MyMar=setInterval(scrolltoleft,40),

			};
		},
		methods: {
			scrolltoleft(){//定义向左移动的方法
			...
			//两面两行是用方法响应对象的事件
			sm.οnmοuseοver(function(){//匿名方法（函数）
