				...
				<div class="b-g-b-content">
					...
					<div class="b-g-b-div">
						<el-steps :space="200" :active="1" finish-status="success">
							...
							<div class="el-step__icon-inner">3</div></div></div><div class="el-step__main"><div class="el-step__title is-wait">等待收货</div><div class="el-step__description is-wait"></div></div></div>
						</el-steps>
					</div>
				</div>
			</div>
