		...
		<div class="card-carousel">
			<div class="card-carousel--overflow-container">
				<div class="card-carousel-cards" :style="{ transform: 'translateX' + '(' + currentOffset + 'px' + ')'}">
					<div class="card-carousel--card" v-for="(item,i) in items" :key="i"><img :src="item.img_url" />
					</div>
				</div>
			</div>
		</div>
	...
	export default {
		data() {
			return {
				...
				items: [{
						img_url:require("../../public/images/details/素材/4_5.png")
					},
					{
						img_url:require("../../public/images/details/素材/4_4.png")
					},
					{
						img_url:require("../../public/images/details/素材/4_1.png")
					},
					{
						img_url:require("../../public/images/details/素材/4_0.png")
					},
					{
						img_url:require("../../public/images/details/素材/5_0.png")
					},
					{
						img_url:require("../../public/images/details/素材/6_3.png")
					},
					 {
						img_url:require("../../public/images/details/素材/8_-2.png")
					},
					{
						img_url:require("../../public/images/details/素材/8-5.png")
					},
					{
						img_url:require("../../public/images/details/素材/3_0.png")
					},
					{
						img_url:require("../../public/images/details/素材/6_1.png")
					},
					{
						img_url:require("../../public/images/details/素材/7_3.png")
					},
				]
			}
		},
