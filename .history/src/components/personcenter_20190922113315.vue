		...
		<div class="content-b">
			<el-form ref="form" :model="form" label-width="80px">
				...
				<el-form-item label="出生日期">
					<div class="block">
						<el-date-picker v-model="birthTime" type="date" placeholder="选择日期">
						</el-date-picker>
					</div>
				</el-form-item>
				<!-- 邮箱 -->
				...
				<el-form-item label="电话号码">
					<div class="intro-input">
						<el-input v-model="phone"></el-input><i class="el-icon-edit"></i>
					</div>
				</el-form-item>
				<!-- 修改密码 -->
				<el-form-item label="修改地址">
					<div class="intro-input">
						<el-input placeholder="新" v-model="password" type="password"></el-input><i class="el-icon-edit"></i>
					</div>
				</el-form-item>
			</el-form>
		</div>
		<a @click="updata()" class="btn btn-light">修改</a>
	</div>
</template>
<script>
	export default {
		...
		methods: {
			...
			//改变表单内部的值
			changedata() {
				this.uname = this.userdata.nickname;
