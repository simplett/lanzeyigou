<template>
	<div>
		...
		<div class="right">
			<div class="login-div">
				<a class="" href="javascript:;" @click="ShowDiv('MyDiv','fade')" id="Button1">登录</a><br>
				<a class="btn btn-danger" href="javascript:;" @click="getUserCenter"  class="chat btn btn-danger">聊天</a><br>
				<a class="btn btn-danger" href="javascript:;" @click="getUserCenter" class="pc btn btn-danger">个人中心</a>
			</div>
